<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li><a id="myCart" href="product_summary.html"><img alt="mycart" src="themes/images/ico-cart.png" />3 Items in your cart  <span class="badge badge-warning pull-right">$155.00</span></a></li>
